...
<nav class="navbar navbar-default">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a href="agregarClinica.html">Agregar clinicas</a></li>
    ...
    <ul class="dropdown-menu">
        ...
        $sql = "SELECT Nombre_Cli, Direccion_Cli, Telefono_Cli, Correo_Ele_Cli FROM clinicas";
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row["Direccion_Cli"] . "</td>";
                echo "<td>" . $row["Telefono_Cli"] . "</td>";
                echo "<td>" . $row["Correo_Ele_Cli"] . "</td>";
                echo "</tr>";
            }
        } else {
            echo "<tr><td colspan='4'>No se encontraron clínicas.</td></tr>";
        }
